  ...
  const PRODUTOS = [
    {
      ...
      nome: "Touca Lavanda",
      imagem:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCfGUAdBkuBTf_fnTcO5Xmvgs54yU5xbY2p34wQNEdUEjAlq8_xY6pHBnOuaV8WQAR_uZ0txsBFHuB0ouzc6cz-5yNRYYotXa1JFOq7XbJkzmL-E1NQB9h5lRN14dpo3K-rG2fOOYWi0uG5GYr95AvTesivyzhINWAXkfT1u3c0_lCIpMnCUjIDku3Y7wQxBla8Mbh6K8KMySzTTIQYJO3xIO--gamTh8mc2SK_8K8uJCf7dKea25TyKzeweTpumPRi-SYRssKgZQpJ",
      fio: "Algodão premium 8/6",
      variantes: [
        { cor: "Lavanda", tamanho: "Único (adulto)", preco: 59.0 },
        { cor: "Areia", tamanho: "Único (adulto)", preco: 59.0 },
        { cor: "Lavanda", tamanho: "Infantil", preco: 52.0 },
      ],
      destaque: true,
    },
    {
      ...
      variantes: [
        { cor: "Mosaic terroso", tamanho: "Único", preco: 65.0 },
        { cor: "Mosaic verde", tamanho: "Único", preco: 68.0 },
      ],
    },
    {
      ...
      variantes: [
        { cor: "Rosa seco", tamanho: "6–12 meses", preco: 120.0 },
        { cor: "Off-white", tamanho: "6–12 meses", preco: 120.0 },
      ],
    },
    {
      id: "bandana-classica",
      ...
      variantes: [{ cor: "Creme", tamanho: "Único", preco: 48.0 }],
    },
    {
      id: "bag-cesto-m",
      categoria: "bags",
      nome: "Cesto Organizador M",
      imagem:
      ...
      variantes: [
        { cor: "Mostarda", tamanho: "M", preco: 45.0 },
        { cor: "Terracota", tamanho: "M", preco: 45.0 },
        { cor: "Mostarda", tamanho: "G", preco: 52.0 },
      ],
      destaque: true,
    },
    {
      ...
      imagem:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDkWln4iOKX3uP8vT-nHRCXlBSWXpUJ7BTAQ8kHfhlFJgVfAaP93FWAjTK9q7xYGIQyURpRqeUJv7ZsM94ZEVt8-W0Y6TFyvzbqMYzYqk9o7EqMnCGeV3fK6Qr_1_j8wcSCgOYP1WTswxrpmFlLdXlJszI5yDsKGf-UQPSozzndzA1u_1bKuTpJ965JobVlab-damnIO36mRK5WH10Uhsd7CX7_0yyG-tATCgtTuSXeO1evhTdYulogzEpr8aKL_PolicUA01bFwx5w",
      fio: "Fio de malha",
      variantes: [{ cor: "Verde sage", tamanho: "P", preco: 38.0 }],
    },
    {
      id: "pareo-nuvem",
      categoria: "pareos",
      ...
      imagem:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAfyfWYjfTBq9-A-h50ZxQyTkyBVLF4m1gFG2yWQJ4wHsX09krCZrN4GVq7T695-meLodiH157fALc3UGQCj5LrJYHmMcpwhSadYJmp-Sk-ypmUttnkFRV2htwb3v1CeDcjyBuv6ncxytMFO5zft8-Gi2E8w1TgQKBofJ2XhUEGUCWGa8zTAuJqvtJJov2Ewi46syZpXgkrFBJ8meaiFsrohD8G3iZVDcbXHhkCeWXRODDPsTFia7QcMtPMo9r7ayXRDCfBoNhj-qDB",
      fio: "Lã merino natural",
      variantes: [
        { cor: "Creme", tamanho: "120×180 cm", preco: 450.0 },
        { cor: "Areia", tamanho: "120×180 cm", preco: 460.0 },
        { cor: "Creme", tamanho: "90×150 cm", preco: 380.0 },
      ],
      destaque: true,
    },
    {
      ...
      variantes: [
        { cor: "Azul mar", tamanho: "150×150 cm", preco: 198.0 },
        { cor: "Coral", tamanho: "150×150 cm", preco: 198.0 },
      ],
    },
    {
      id: "colar-coelho",
      ...
      variantes: [
        { cor: "Bege", tamanho: "Pingente 4 cm", preco: 129.0 },
        { cor: "Rosa", tamanho: "Pingente 4 cm", preco: 129.0 },
      ],
    },
    {
      id: "colar-ursinho",
      ...
      fio: "Algodão mercerizado",
      variantes: [
        { cor: "Marrom médio", tamanho: "Pingente 5 cm", preco: 189.9 },
        { cor: "Caramelo", tamanho: "Pingente 5 cm", preco: 189.9 },
      ],
    },
    {
      id: "coelho-algodao",
      ...
      fio: "Algodão 100%",
      variantes: [{ cor: "Marrom", tamanho: "Pingente 3,5 cm", preco: 85.0 }],
    },
  ];
